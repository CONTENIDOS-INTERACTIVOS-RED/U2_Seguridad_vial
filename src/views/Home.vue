        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad #[b Implementación y control de medidas de seguridad vial laboral], capacita a profesionales para reducir riesgos en la movilidad laboral mediante estrategias integrales. Incluye la planificación y ejecución del plan estratégico de seguridad vial, verificación organizacional, análisis de factores (vehículo, conductor, entorno y organización), evaluación de riesgos y aplicación de controles. También contempla la elaboración de planes de emergencia. Se basa en normativas como la Resolución 40595 del 2022 e integra tecnologías, formación y cultura preventiva para fortalecer la seguridad vial en el entorno laboral.
